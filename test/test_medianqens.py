...
class Test_MedianQEns(unittest.TestCase):
    def test_MedianQEns_calc_kde_rectangle_bw_equal_distance(self):
        ...
        actual_rectangle_bw = qens.MedianQEns().calc_kde_rectangle_width(q = tf.constant(q), train_q = True)
    ...
    def test_MedianQEns_weighted_cdf(self):
        ...
        rectangle_bw = qens.MedianQEns().calc_kde_rectangle_width(q = tf.constant(q), train_q = True)
        ...
        rectangle_bw = qens.MedianQEns().calc_kde_rectangle_width(q = q, train_q = True)
    ...
    def test_MedianQEns_predict(self):
        ...
        model = qens.MedianQEns()
        rectangle_bw = model.calc_kde_rectangle_width(q = tf.constant(q), train_q = True)
        prediction = model.predict(tf.constant(q), train_q = False, w = {'w': tf.constant(w)})
